        ...
        <section className="py-24 bg-[var(--color-brand-white)]">
            <div className="max-w-[1100px] mx-auto px-6">
                ...
                <div className="text-center mb-16 flex flex-col items-center">
                    <h2 className="text-[36px] md:text-[48px] font-bold text-[var(--color-brand-blue)] mb-4 max-w-[800px] font-[family-name:var(--font-jakarta)] leading-[1.1]">
                        Everything your team needs to <br className="hidden md:block" />
                        move <span className="text-[var(--color-brand-green)]">Forward</span>
                    </h2>
                    <p className="text-[16px] text-[var(--color-brand-blue)]/60 font-medium mt-2">
...
function FeatureCard({ icon: Icon, title, desc }: { icon: LucideIcon, title: string, desc: string }) {
    return (
        <motion.div
            initial="initial"
            whileHover="hover"
            className="group relative bg-white rounded-[28px] p-8 md:p-10 flex flex-col md:flex-row items-start gap-6 transition-all duration-300 border border-transparent hover:border-[#05B29B]/50 hover:shadow-[0_20px_40px_rgba(5,178,155,0.15)] shadow-[var(--shadow-raised)]"
        >
            {/* Icon Box */}
            <motion.div
                variants={{
                ...
                className="w-16 h-16 rounded-[20px] flex-shrink-0 flex items-center justify-center transition-colors duration-300 bg-[#05B29B]/10 text-[#05B29B]"
            >
            ...
            <div className="flex flex-col gap-2">
                <motion.h3
                    ...
                    className="text-2xl font-bold font-[family-name:var(--font-jakarta)] transition-colors duration-300"
                >
                    {title}
                </motion.h3>

                <p className="text-[15px] leading-relaxed text-[var(--color-brand-blue)]/60 font-[family-name:var(--font-inter)] font-medium">
                    {desc}
                </p>
            </div>
        </motion.div>
