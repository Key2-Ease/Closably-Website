...
export function Testimonials() {
    return (
        <section className="py-10 md:py-24 bg-[var(--color-brand-white)] border-t border-gray-100">
            <div className="max-w-[1200px] mx-auto px-6">
                <div className="text-center mb-4 md:mb-16 flex flex-col items-center">
                    <h2 className="text-xl sm:text-2xl lg:text-[56px] font-bold mb-6 max-w-[800px] text-[var(--color-brand-blue)] leading-tight">
                        Loved by sales teams at top companies
                    </h2>
                </div>

                <div className="grid grid-cols-2 lg:grid-cols-2 gap-3 md:gap-8 mb-12">
                    <NeuCard variant="light" className="p-4 md:p-8 hover:-translate-y-1 transition-transform duration-300">
                        <p className="text-xs md:text-lg leading-relaxed text-[var(--color-brand-blue)]/80 mb-3 md:mb-6 italic">
