...
export function CredibilityTrust() {
    return (
        <section id="proof" className="py-10 md:py-24 bg-[var(--color-brand-white)]">
            <div className="max-w-[1200px] mx-auto px-6">
                <div className="text-center mb-4 md:mb-16 flex flex-col items-center">
                    <h2 className="text-xl sm:text-2xl md:text-[56px] font-bold mb-6 max-w-[800px] text-[var(--color-brand-blue)] leading-tight">
                        <span className="text-[var(--color-brand-green)]">Enterprise discipline</span> without enterprise friction
                    </h2>
                </div>

                <div className="grid grid-cols-2 md:grid-cols-2 gap-3 md:gap-6 lg:gap-8 mb-12">
                    <NeuCard variant="light" className="p-4 md:p-8 group hover:-translate-y-1 transition-transform duration-300">
                        ...
                        <h3 className="text-sm md:text-2xl font-bold mb-2 md:mb-3 text-[var(--color-brand-blue)] group-hover:text-[var(--color-brand-green)] transition-colors duration-300 line-clamp-2 md:line-clamp-none">Human in the loop by default</h3>
                    ...
                    <NeuCard variant="light" className="p-4 md:p-8 group hover:-translate-y-1 transition-transform duration-300">
                        <div className="w-8 h-8 md:w-12 md:h-12 rounded-xl bg-[#05B29B]/10 shadow-none flex items-center justify-center mb-3 md:mb-6 text-[#05B29B] group-hover:bg-[var(--color-brand-green)] group-hover:text-white transition-colors duration-300">
                            <ShieldAlert size={16} className="md:w-6 md:h-6" />
                        </div>
                        <h3 className="text-sm md:text-2xl font-bold mb-2 md:mb-3 text-[var(--color-brand-blue)] group-hover:text-[var(--color-brand-green)] transition-colors duration-300 line-clamp-2 md:line-clamp-none">Built for messy real world data</h3>
                        <p className="text-xs md:text-base text-[var(--color-brand-blue)]/60 leading-relaxed line-clamp-3 md:line-clamp-none">
                    ...
                    <NeuCard variant="light" className="p-4 md:p-8 group hover:-translate-y-1 transition-transform duration-300">
                        <div className="w-8 h-8 md:w-12 md:h-12 rounded-xl bg-[#05B29B]/10 shadow-none flex items-center justify-center mb-3 md:mb-6 text-[#05B29B] group-hover:bg-[var(--color-brand-green)] group-hover:text-white transition-colors duration-300">
                            <BadgeCheck size={16} className="md:w-6 md:h-6" />
                        </div>
                        <h3 className="text-sm md:text-2xl font-bold mb-2 md:mb-3 text-[var(--color-brand-blue)] group-hover:text-[var(--color-brand-green)] transition-colors duration-300 line-clamp-2 md:line-clamp-none">Purpose built for B2B SaaS</h3>
                        <p className="text-xs md:text-base text-[var(--color-brand-blue)]/60 leading-relaxed line-clamp-3 md:line-clamp-none">
