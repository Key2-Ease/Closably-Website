    ...
    return (
        <>
            <div className="fixed top-6 left-0 right-0 z-50 flex justify-center px-4 pointer-events-none">
                <header className="bg-white shadow-xl rounded-[24px] px-2 pl-6 py-2 flex items-center justify-between gap-8 lg:gap-12 pointer-events-auto max-w-[1000px] w-full mx-auto">
                    ...
                    {/* Mobile Menu Button */}
                    <button
                        className="lg:hidden p-2 text-[#161E2E] mr-2"
